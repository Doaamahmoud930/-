...
use App\Http\Controllers\Api\V1\Rest\RestsController;
use App\Http\Controllers\Api\V1\Report\ReportsController;
...
Route::group(['prefix' => 'v1'], function() {
    ...
    Route::group(['middleware' => ['auth:sanctum', 'verified']], function() {
        ...
        Route::apiResource('/rests', RestsController::class);
